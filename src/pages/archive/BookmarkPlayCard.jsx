          ...
          list.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="album">
                  <img
                    src={item.img || item.imageUrl || "/assets/images/album_cover/defaultAlbumCover.jpg"}
                ...
                <div className='like'>
                  <img src="/assets/images/icons/svg/like=on.svg" alt="좋아요" />
                </div>
                <div className='play'>
                  <img src="/assets/images/icons/svg/music_prev.svg" />
                  <img src="/assets/images/icons/svg/music_play.svg" />
                  <img src="/assets/images/icons/svg/music_next.svg" />
                </div>
              </S.PlayedCardBox>
            );
          })
