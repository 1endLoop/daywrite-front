            ...
            <div id="title">
              ...
              <p
                onClick={() => {
                  if (editMode) {
                    // 편집 종료: 선택된 항목 삭제
                    setBookmarkData((prev) => prev.filter((item) => !selectedItems.includes(item.id)));
        ...
        <S.PlayBox>
          ...
          {bookmarkData.map((item, index) => (
            ...
            >
              ...
              {/* 좋아요 */}
              <div className="like">
                <img src="/assets/images/icons/like-on-color.png" alt="" />
              </div>
              {/* 재생 */}
              <div className="play">
                <img src="" alt="" />
            ...
            <div className="popup-box">
              ...
              <div className="popBody">
                ...
                <div className="bookDetail">
                  ...
                  <p>
                    <strong>Music:</strong> {selectedItem.music} - {selectedItem.artist}
                  </p>
                </div>
              </div>
            </div>
