  ...
  return (
    <Card.Card onClick={onClick}>
      <Card.Header>
        <Card.LeftInfo>
          <Card.Profile
            src={profileImg || "../assets/images/profiles/profile2.jpeg"}
            alt="profile"
          />
          <Card.TitleWrapper>
        ...
        <Card.RightInfo>
          <Card.LikeIcon
            ...
            src={
              liked
                ? "../assets/images/icons/svg/thumb=on.svg"
                : "../assets/images/icons/svg/thumb=off.svg"
            }
            alt="like"
            onClick={(e) => {
              e.stopPropagation();
          ...
          <span>{likes}</span>
          <Card.CommentIcon
            src="../assets/images/icons/svg/comment.svg"
            alt="comment"
          />
          <span>{comments}</span>
        </Card.RightInfo>
